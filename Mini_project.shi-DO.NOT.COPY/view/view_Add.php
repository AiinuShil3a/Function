                                ...
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <form method="POST" action="../controller/controller_Add.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col">
                                                <div class="form-outline">
                                                    <input type="number" id="no" name="no" class="form-control" placeholder="รหัสนักศึกษา" required />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col">
                                                ...
                                                <input type="text" id="year" name="year" class="form-control" placeholder="ปีที่เข้ารับการศึกษา" required />
                                                </div>
                                            </div>
                                            <div class="col">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-3">
                                                <div class="form-outline">
                                                    <input type="number" id="co1" name="co1" class="form-control" required />
                                                </div>
                                            </div>
                                            <div class="col-3">
                                                <div class="form-outline">
                                                    <input type="number" id="co2" name="co2" class="form-control" required />
                                                </div>
                                            </div>
                                            <div class="col-3">
                                                <div class="form-outline">
                                                    <input type="number" id="co3" name="co3" class="form-control" required />
                                                </div>
                                            </div>
                                            <div class="col-3">
                                                <div class="form-outline">
                                                    <input type="number" id="co4" name="co4" class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-4">
                                                <div class="form-outline">
                                                    <input type="number" id="DM" name="DM" class="form-control" placeholder="VALID" required />
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="form-outline">
                                                    <input type="number" id="DY" name="DY" class="form-control" placeholder="THRU" required />
                                                </div>
                                            </div>
                                        </div>
                                        <center>
